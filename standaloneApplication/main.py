...
'''
def openfileEnc():
	filename = tkFileDialog.askopenfilename(initialdir = "/home/adhya/Desktop",title = "Select file",filetypes = (("text files","*.txt"),("all files","*.*")))
	fileToEncrptyEntryUpdate(filename)

def opendirectoryEnc():
	directory = tkFileDialog.askdirectory(initialdir = "/home/adhya/Desktop",title = "Select directory")
...
def opengithub(event):
	webbrowser.open_new(r"https://github.com/adhyamuru/thrain")

def openAdhyalinkedin(event):
	webbrowser.open_new(r"https://www.linkedin.com/in/adhyamurugesan")

def openSindhurilinkedin(event):
	webbrowser.open_new(r"https://www.linkedin.com/in/lakshmi-sindhuri-pallapothu-494042130/")
'''
-----------------------------------------------------------------
UPDATE ENTRY LABELS
-----------------------------------------------------------------
...
#		sticky='NS', padx=5, pady=5)
	...
	Adhyasocial = Label(Aboutus, text="Adhya")
	Adhyasocial.bind("<Button-1>",openAdhyalinkedin)
	Adhyasocial.grid(row=5, sticky='SW',padx = 8)
	text3 = Label(Aboutus, text="|")
	text3.grid(row=5)
	Sindhurisocial = Label(Aboutus, text="Sindhuri")
	Sindhurisocial.bind("<Button-1>",openSindhurilinkedin)
	Sindhurisocial.grid(row=5, sticky='SE',padx = 8)
    '''
